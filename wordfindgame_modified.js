    ...
    var endTurn = function () {
      ...
      for (var i = 0, len = wordList.length; i < len; i++) {
        ...
        if (wordList[i] === curWord) {
          ...
          Qualtrics.SurveyEngine.setEmbeddedData('num_found',num_words - wordList.length);
          var d = new Date();
          Qualtrics.SurveyEngine.setEmbeddedData('time_last_word_found',d.getHours());
        }
